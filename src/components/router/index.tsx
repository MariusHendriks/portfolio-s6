                            ...
                            <a href="/ikwil">
                                <div className="o-card">
                                    ...
                                    <p className="o-card__text">
                                        Tijdens dit project is er een dashboard
                                        gebouwd voor stichting ik wil. Er is
                                        onderzoek gedaan dichbij de gebruikers
                                        en er werd op locatie gewerkt.
                                    </p>
                                </div>
                            </a>
                            <a href="/pidz">
                                <div className="o-card">
                                    ...
                                    <h1>Pidz</h1>
                                    <p className="o-card__text">
                                        Tijdens dit project is er een nieuw
                                        platform ontworpen:"WijPIDZ". Op dit
                                        platform kunnen ZZP'ers die in de zorg
                                        werken opleidingen volgen, artikelen
                                        kopen en communities vormen door o.a.
                                        vragen te stellen aan elkaar.
                                    </p>
                                </div>
                            </a>
                        </div>
