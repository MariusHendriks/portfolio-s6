    ...
    <>
      <div className="o-pagenav">
        ...
        <div>
          ...
          <button onClick={() => executeScroll(Opdracht, 400)}>
            De opdracht
          </button>
          <button onClick={() => executeScroll(Probleemstelling, 400)}>
            Probleemstelling
          </button>
          <button onClick={() => executeScroll(Aanpak, 400)}>Aanpak</button>
          <button onClick={() => executeScroll(Resultaat, 400)}>
            Resultaat
          </button>
          <button onClick={() => executeScroll(Reflectie, 400)}>
            Reflectie
          </button>
          ...
          <FadeIn>
            ...
            <div ref={Opdrachtgever}>
              ...
              <p>
                ...
                zoeken van verbinding en het delen van talenten, voor iedereen.
                De stichting bouwt aan een samenleving waar iedereen bij hoort.
                Bezoekers komen naar de stichting om verschillende redenen. Je
                kan er heen om dingen te leren, te ontspannen, vrienden te maken
                en elkaar te helpen. Er zijn activiteiten als schilderen,
                papierwerk, naaien of het leren van een taal. De laatste tijd
                houdt de stichting zich ook bezig met beginnende bedrijven die
                binnen de stichting zijn ontstaan door de gevonden talenten bij
                de deelnemers.
              </p>
            </div>
            <div ref={Opdracht}>
              ...
              <p>
                ...
                Daar willen ze in samenwerking met Fontys Hogescholen kijken
                naar waar verbetering mogelijk is. De opdracht was erg vrij, er
                was geen vastgezet probleem dat een oplossing nodig had, in
                plaats daarvan moesten wij studenten op zoek gaan naar waar
                mogelijk verbetering nodig was.
              </p>
            </div>
            ...
            <div ref={Aanpak}>
              ...
              <p>
                ...
                beantwoord heb is: Hoe zien de processen binnen de stichting er
                uit? (
                <Link to="page/OnderzoeksDocument/">Link naar onderzoek</Link>).
                Nadat alle duo’s conclusies hebben getrokken uit de onderzoeken
                is er een brainstormsessie geweest (
              ...
              <ul className="c-double-ul">
                ...
                <li>
                  ...
                  te bieden heeft. De activiteiten van de komende week zullen er
                  op komen staan, wat voor eten er die dag is en welk bestuur er
                  die dag is. Dit idee is opgepakt door{" "}
            ...
            <div ref={Reflectie}>
              ...
              <p>
                ...
                werken, aangezien daar veel onduidelijkheid was over wie wat aan
                het doen was.{" "}
              </p>
              <p>
                ...
                database heb opgezet was niet ideaal. De structuur was overigens
                wel besproken met de andere groepsgenoten die ermee te maken
                zouden hebben, en door hen goedgekeurd. Aan het einde liep de
                app-groep tegen allerlei complicaties aan, terwijl het dashboard
                al af was. Er is besproken wat de beste oplossing was, en om
                alles om te bouwen was niet mogelijk binnen de tijd. Er waren
                verder nauwelijks onduidelijkheden over de geschreven code.
              </p>
              <p>
                ...
                standaard is, en nu ik het begrijp ga ik er in mijn toekomst nog
