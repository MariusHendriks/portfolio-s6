    ...
    <>
      <div className="o-pagenav">
        ...
        <div>
          ...
          <button onClick={() => executeScroll(Uitprobeersels, 20)}>
            Uitprobeersels
          </button>
            ...
            <div>
              ...
              <div ref={Resultaat}>
                ...
                <p>
                  ...
                  versie van het prototype te vinden met eronder waarom het er
                  op deze manier uit ziet.
                </p>
                <p>
                  ...
                  <div className="s-page__content__img__container">
                    ...
                    <div className="s-page__content__img__container__img">
                      ...
                      <p>
                        ...
                        geïnspireerd van Stackoverflow. De algehele opbouw van
                        het profiel is geïnspireerd van Facebook.
                      </p>
                    </div>
                  </div>
                  <div className="s-page__content__img__container">
                ...
                <div ref={Uitprobeersels}>
                  ...
                  <p>
                    Er zijn verschillende dingen uitgeprobeerd om tot een uniek
                    en beter ontwerp te komen. Geen ontwerp is gemaakt zonder
                    iteraties.
                  </p>
                  <div className="s-page__content__img__container">
                    <div className="s-page__content__img__container__img">
                      ...
                      <p>
                        Hier was een simpele visuele upgrade door gebruik te
                        maken van iconen. Op deze manier zag het er direct een
                        stuk beter uit.
                      </p>
                    </div>
                    <div className="s-page__content__img__container__img">
                      ...
                      <p>
                        Er is geëxperimenteerd met de chat de linkerbalk te
                        laten vervangen. Na een gesprek met de opdrachtgever en
                        de groep zijn we tot de conclusie gekomen dat dit
                        simpelweg niet handig in gebruik is omdat je niet door
                        het menu kan navigeren terwijl je een chat open hebt.
                      </p>
                    </div>
                  </div>
                </div>
                <div ref={Verantwoording}>
                  ...
                  <p>
                    ...
                    van de gemaakte proof of concepts die door Dylano Hartman,
                    Max Altena en mij gemaakt zijn. Er was door de proof of
                    concepts ook al duidelijk wat er in het ontwerp moest komen,
                    en de rollen zijn verdeelt.
                  </p>
                  <p>
