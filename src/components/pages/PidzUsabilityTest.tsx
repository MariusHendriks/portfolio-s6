    ...
    <>
      <div className="o-pagenav">
        ...
        <div>
          ...
          <button onClick={() => executeScroll(Procedure, 20)}>
            Procedure
          </button>
          <button onClick={() => executeScroll(Uitvoering, 20)}>
            Uitvoering
          </button>
            ...
            <div>
              ...
              <div ref={Aanleiding}>
                ...
                <p>
                  ...
                  maar met minder ideale personen testen is beter dan niet
                  testen.
                </p>
              </div>
              <div ref={Methode}>
                ...
                <p>
                  ...
                  meerdere kandidaten tegen hetzelfde probleem aanlopen of als
              ...
              <div ref={Procedure}>
                ...
                <p>
                  ...
                  zal het prototype worden opgestuurd. Zodra deze in goede orde
                  is geopend zal er aan de testpersoon verteld worden wat
                  zijn/haar taak is. Na afloop zullen er vragen gesteld worden.
                </p>
                <p>
                  <b>Manier 2: Fysiek.</b>
                  <br />
                  Er zal fysiek getest worden op een laptop waar het prototype
                  al klaar staat. Hier wordt de test op de ‘normale’ manier
              ...
              <div ref={Conclusie}>
                ...
                <p>
                  ...
                  vinkje een zogenaamde ‘hover state’ geven, en de grootte van
                  de knop vergroten.
                </p>
                <p>
                  Een iets minder grote issue is dat het niet genoeg opviel dat
                  er een nieuw chatbericht was. Dit gaat in de tweede iteratie
                ...
                <div>
                  ...
                  <p>
                    De personen probeerde altijd het beste antwoord te
                    selecteren door te upvoten. De eerste upvote die de persoon
                    nu geeft op zijn/haar eigen post, wordt automatisch
                    gemarkeerd als het 'beste' antwoord. Dit is omdat de
                    gebruiker pas op de upvote of de markering van het juiste
                    antwoord klikt zodra hij/zij zeker weet wat hij/zij het
                    beste antwoord vind.
                  </p>
                  <h3>Iteratie 2.5</h3>
                  <p>
