      ...
      <div className="s-page__content">
        <FadeIn>
          ...
          <div>
            <h2>Uitvoering</h2>
            <p>
              Met alle resultaten van de onderzoeken die gemaakt zijn in duo's
              is heeft een brainstormsessie plaast gevonden. Per duo is verteld
              wat de resultaten van het onderzoek waren, waar vervolgens 10
              minuten over is gebrainstormed. Daarna is alles gecatogoriseerd
              wat bij elkaar hoorde en zijn alleen de nuttige ideeën gebleven.
              Hieruit zijn "How might we" vragen opgesteld. Die vragen waren:
            </p>
            <ol>
              <li>
          ...
          <div>
            ...
            <ul className="c-double-ul">
              ...
              <li>
                ...
                zich hier voor inschrijven. Dit idee is opgepakt door{" "}
