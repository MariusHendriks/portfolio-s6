    ...
    <>
      <div className="o-pagenav">
        ...
        <div>
          ...
          <button onClick={() => executeScroll(Doelgroep, 120)}>
            Doelgroep
          </button>
          <button onClick={() => executeScroll(Doelstellingen, 120)}>
            Doelstellingen
          </button>
          <button onClick={() => executeScroll(Media, 120)}>Media</button>
          <button onClick={() => executeScroll(Boodschap, 120)}>
            Boodschap
          </button>
          <button onClick={() => executeScroll(Propositie, 120)}>
            Propositie
          </button>
          ...
          <FadeIn>
            ...
            <div ref={Aanleiding}>
              ...
              <p>
                ...
                eerste gebruikers zullen ZZP’ers zijn die nu al op het MijnPIDZ
                systeem zitten. Deze zullen geïnformeerd worden over het WijPIDZ
                systeem, en hier zullen hopelijk actieve leden uit volgen.
              </p>
            ...
            <div ref={Doelgroep}>
              ...
              <p>
                ...
                vooronderzoek. Dit profiel is opgesteld vanuit 5 interviews en 3
                gesprekken. Er is in te zien waar de ZZP’ers vrolijk van worden,
                frustrerend vinden en wat hun taken zijn.
              </p>
              <h3>Persona</h3>
              <p>
                Om in een oogopslag te zien wie de gebruiker is, is er een
                persona gemaakt. De persona is gebaseerd op twee delen. Als
                eerst op de gebruikersprofiel die is aangeleverd door PIDZ. Hier
                is gekeken naar de grootste frustraties, waar de ZZP’ers vrolijk
                van worden en de taken die ze verrichten. Daarnaast zijn er op
                Facebook profielen van gebruikers die of vragen stelden, of op
                antwoord gaven op vragen in de Facebook groep: “ZZP’ers in de
                zorg”. Er is uitbundig gezocht naar wat voor een mensen het
                zijn, wat hun leeftijd is, wat voor berichten ze op facebook
                plaatste. Er zijn verder geen interviews of dergelijke geweest,
                omdat we hier geen toestemming voor hadden gekregen van PIDZ.
              </p>
              <div className="s-page__content__img__container__img">
                <Zoom>
                  <img
            ...
            <div ref={Media}>
              ...
              <p>
                ...
                specifieke adds zijn voor ZZP’ers in de zorg (bijvoorbeeld door
                te targetten voor mensen die in dergelijke groepen zitten),
                zullen er zeker meer views komen op het product, en daardoor
                hopelijk leden.
              </p>
              ...
              <p>
                ...
                in de zorg" [2]. Als ze hier een platform promoten waar al deze
                ZZP’ers op een juiste manier hun vragen kunnen stellen zullen ze
                ook bij ‘awareness’ uitkomen op de customer journey.
              </p>
              ...
              <p>
                ...
                gebruikers zouden geïnformeerd kunnen worden over WijPIDZ via de
                mail of een nieuwsbrief waarin alles over het nieuwe product te
                vinden is. Op deze manier komen er leden die al bij Pidz
                aangesloten zijn naar hun nieuwe product.
              </p>
            </div>
            <div ref={Media}>
              <h2>Metrics</h2>
              <p>
                Om te meten of de doelen behaald worden, kunnen er verschillende
                dingen gemeten worden. Zo kan er bijgehouden worden wat de CPC
                (cost per click) zou zijn bij facebook ads. Daarnaast kunnen ze
                kijken hoeveel procent van de kanalen waar ze mensen werven
                actief lid wordt. Simpelweg lid worden is al een win, maar als
                de persoon ook actief is met het beantwoorden en stellen van
                vragen is de kans groter dat de persoon in de loyalty fase komt
              ...
              <p>
                ...
                conclusies uit trekken dat het product actiever gebruikt wordt.
              </p>
            </div>
            <div ref={Boodschap}>
              <h2>Boodschap</h2>
              ...
              <p>
                ...
                duidelijk voor de <b>ZZP’ers</b> dat het gaat om een{" "}
                <b>product voor hen</b>, waar ze zelf <b>elkaar</b> helpen.
              </p>
            </div>
            <div ref={Propositie}>
              <h2>Propositie</h2>
              ...
              <p>
                ...
                ) geleend. Hierin staat wat het product te bieden heeft voor de
                ZZP’ers, maar ook voor de bemiddelaars.
              </p>
            ...
            <div ref={Bronnen}>
              <h2>Bronnen</h2>
              <p>
                [1] Pidz Facebook. (z.d.). Facebook. Geraadpleegd 22 juni 2020,
                van{" "}
                <a
                  target="_blank"
              ...
              <p>
                [2] ZZP'ers in de Zorg Facebook. (z.d.). Facebook. Geraadpleegd
                22 juni 2020, van{" "}
                <a
                  target="_blank"
                  rel="noopener noreferrer"
              ...
              <p>
                [4] Microsoft Stream. (2020, 24 april). Geraadpleegd op 22 juni
                2020, van{" "}
                <a
                  target="_blank"
                  rel="noopener noreferrer"
