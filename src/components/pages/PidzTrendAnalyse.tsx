    ...
    <>
      <div className="o-pagenav">
        ...
        <div>
          ...
          <button onClick={() => executeScroll(Trends, 120)}>
            Gevonden Trends
          </button>
          <button onClick={() => executeScroll(ConsumerCanvas, 120)}>
            Consumer Canvas
          </button>
          ...
          <FadeIn>
            ...
            <div ref={Aanleiding}>
              ...
              <p>
                ...
                trends zijn voor ZZP’ers. Er is eerst gekeken naar wat een trend
            ...
            <div ref={ConsumerCanvas}>
              ...
              <p>
                Er is gekozen om een consumer canvas te maken van de trend ‘Meer
                nadruk op freelance service en community-ondersteuning’ omdat
                het erg belangrijk is dat deze trend goed begrepen wordt en hoe
